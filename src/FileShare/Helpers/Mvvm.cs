...
/// <summary>Generic ICommand implementation for commands that take a typed parameter.</summary>
...
/// <summary>Async relay command that guards against re-entrancy while a task is running.</summary>
